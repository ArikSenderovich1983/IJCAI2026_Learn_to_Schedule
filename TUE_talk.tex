...
\begin{frame}{Context: Business Process Optimization (BPO)}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            \item \textbf{Task Prioritization:} Which waiting case to process next?
            \item \textbf{Resource Allocation:} Which resource to assign to a task?
            \item \textbf{Case Admission:} When to admit/schedule a case?
        ...
        \centering
        \textbf{Objectives:} \\
        Min.\ Cost, Max.\ Throughput, Min.\ Waiting Time.
    \end{columns}
...
\begin{frame}{Focus: Scheduling Under Duration Uncertainty}
    ...
    \vspace{0.5em}
    \begin{itemize}
        \item \textbf{Ideal World:} If we knew task durations $y$, we could use optimal policies (SPT, Johnson's Rule).
        \item \textbf{Real World:} Durations are unknown and stochastic.
        \item \textbf{Standard Approach:} Use heuristics or deterministic averages.
    \end{itemize}
