...
Concerning Problem~2, Figure~\ref{fig:Linear_dataset_2_machine_problem}, as highlighted in Table~\ref{tab:linear_dataset_results}, shows that no method consistently outperforms the others across all noise levels. In particular, MSE and SPO+ lack robustness and can be the best or worst methods depending on the noise level, showing also a huge variance over the . However, SASS, while not always the best, demonstrates consistent performance regardless of the presence of noise.
