...
Tabke~\ref{tab:linear_dataset_1machine_results} 
...
\label{tab:linear_dataset_1machine_results}
\end{table}
...
In contrast, our framework directly exploits the critical-decision structure of polynomial-time rules, enabling stable learning.
