...
\noindent\textbf{Step 1: Identify Unknown Parameters.} For each job $i$, define the unknown parameter vector $\theta_i^\star$ governing
...
decisions through $\sigma(s_d/\lambda)$ and uses $\phi_d(\theta^\star)$ to reflect
