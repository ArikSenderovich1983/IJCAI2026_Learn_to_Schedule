...
\begin{itemize}
    \item $\Delta_{ij} = (f_\omega(x_j) - f_\omega(x_i))$ hence, if $\Delta_{ij}$ is positive the model is rewarded otherwise is penalized.
    \item $\Delta_{ij} = \min(\hat{p}_{i1}, \hat{p}_{j2}) -\min(\hat{p}_{j1}, \hat{p}_{i2})$ 
\end{itemize}
...
\multirow{2}{*}{Method} & \multicolumn{6}{c}{Noise Level} \\
                         & 0 & 2 & 4 & 6 & 8 & 10 \\
\midrule
MSE     & \textbf{0.017} & \textbf{0.045} & 0.107 & \textbf{0.143} & 0.237 & 0.197 \\
Rank Loss  & 0.123 & 0.064 & 0.109 & 0.176 & 0.197 & 0.181 \\
Regret Loss & 0.018 & 0.066 & \textbf{0.085} & 0.168 & \textbf{0.153} & \textbf{0.184} \\
SPO+ & - & - & - & - & - & - \\
\bottomrule
\end{tabular}}
