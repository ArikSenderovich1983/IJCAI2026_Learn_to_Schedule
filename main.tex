...
To validate this positioning, we compare SASS against three 
types of approaches: 1. a predict-then-optimize method that minimizes
the mean-squared error (MSE), unaware of the scheduling objective, 2. a learn-to-rank (LTR) method
that sees the scheduling problem as a ranking problem, and 3. an SPO-based efficient baseline dubbed SPO+ (proposed in~\cite{elmachtoub2022smart}).
