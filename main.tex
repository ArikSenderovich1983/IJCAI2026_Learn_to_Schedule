...
\begin{itemize}
    ...
    \item \emph{Nonlinear model (Problem~1):} A nonlinear combination is computed as:
    \[
...
\todo[inline]{Add confidence intervals to show the problem of MSE unstability}
...
\multirow{2}{*}{Method} & \multicolumn{6}{c}{Noise Level} \\
                         & 0 & 2 & 4 & 6 & 8 & 10 \\
\midrule
MSE     & 0.576\pm0.28 & 0.363\pm0.26 & 0.359 & 0.701 & 0.706 & 1.132 \\
Rank Loss  & 0.225\pm0.05 & 0.284\pm0.05 & 0.356 & 0.494 & 0.647 & 0.976 \\
Regret Loss & \textbf{0.209}\pm0.04 & \textbf{0.222}\pm0.05 & \textbf{0.270} & \textbf{0.402}\pm0.24 & \textbf{0.622} & \textbf{0.954} \\
SPO+ & 29.135\pm0.18 & 13.419 & 6.607 & 35.705 & 14.961 & 25.287 \\
\bottomrule
\end{tabular}}
...
SPO+ & 17.746 & 19.784 & 16.416 & 22.234 & 19.753 & 15.003 \\
\bottomrule
\end{tabular}}
...
\multirow{2}{*}{Method} & \multicolumn{6}{c}{Noise Level} \\
                         & 0 & 2 & 4 & 6 & 8 & 10 \\
\midrule
MSE     & \textbf{0.017} &  & 0.107 &  & 0.237 &  \\
Rank Loss  & 0.123 &  & 0.109 &  & 0.197 &  \\
Regret Loss & 0.018 & & \textbf{0.085} &  & \textbf{0.153} &  \\
SPO+ & - & - & - & - & - & - \\
\bottomrule
\end{tabular}}
\caption{Makespan errors across with nonlinear dataset with different noise level. Size $10000$.}
\label{tab:linear}
\end{table}
